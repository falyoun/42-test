...
describe('Testing hierarchical sort for big data', function () {
    ...
    test('Sorting by net_sales', () => {
        ...
        writeFileSync(`${outputDirectory}/big-data-tree.json`, JSON.stringify(rootNode, null, 2));
        ...
        treeInstance.output(rootNode, header, `${outputDirectory}/data-big-output.txt`);
